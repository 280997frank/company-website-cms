// import { ModuleType } from "@/types/products";
import {
  array,
  boolean,
  date,
...
// export const arrayOfModules = array().of(
//   object().shape({
//     type: string(),
//     text: optionaString.when("type", {
//       is: (type: string | ModuleType) => type === "TEXT",
//       then: requiredString,
//     }),
//     videoTitle: optionaString.when("type", {
//       is: (type: string | ModuleType) => type === "VIDEO",
//       then: requiredString,
//     }),
//     videoUrl: optionalFile.when("type", {
//       is: (type: string | ModuleType) => type === "VIDEO",
//       then: requiredFile,
//     }),
//     productImages: array()
//       .of(optionalFile)
//       .when("type", {
//         is: (type: string | ModuleType) => type === "IMAGE",
//         then: arrayOfRequiredFiles,
//       }),
//   })
// );
